    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-3 text-muted">
          <h1><strong><?php echo $row1["課程名稱"] ?></strong></h1>
        </div>
      </div><br>
      <div class="row">
        ...
        ?>
          ...
          <div class="card" style="width: 68%;">
            ...
            <div align=right>
              <a href="/sa/system/collect/add2collect.php?comment_id=<?= $comment_id; ?>&id=<?=$id;?>">
              <button type="button" class="btn btn-info" style="width:90px">加入收藏</button>
              </a>

              <a href="delete.php?id=<?php echo $c_row[1] ?>&comment_id=<?= $comment_id; ?>">
              <button type="button" class="btn btn-danger" style="width:90px">刪除評論</button>
            </a>
            </div>
          </div>
        <?php } ?>
